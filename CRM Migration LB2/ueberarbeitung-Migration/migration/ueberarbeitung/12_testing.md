...
| 3 | Netzwerk | Namensauflösung crm.local | → 192.168.42.135 | ✅ |
| 4 | Netzwerk | Namensauflösung crm-db.local | → 192.168.42.134 | ✅ |
...
| 10 | Datenbank | Remote-Verbindung von .135 | Login erfolgreich | ✅ |
| 11 | Datenbank | Tabellenanzahl | 147 Tabellen | ✅ |
| 12 | Datenbank | Benutzeranzahl in vtiger_users | 3 (identisch mit Altsystem) | ✅ |
| 13 | Datenbank | Zugriff von ausserhalb .135 | Verbindung verweigert | ✅ |
...
# (leere Testdatenbank mit importierten Daten prüfen)
